...
@section('title','E-SHOP || Admin Profile')
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body mt-4 ml-2">
                        ...
                        <p class="card-text text-left"><small class="text-muted"><i class="fas fa-hammer"></i> {{$profile->role[0]->name}}</small></p>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('profile-update',$profile->id)}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="thumbnail" class="form-control" type="text" value="{{--$profile->photo--}}">
                        </div>
                        @error('photo')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
