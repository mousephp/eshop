...
{{-- shop\resources\views\frontend\blog-detail\blog_single.blade.php --}}
{{-- // Like Or Dislike --}}
<script>
    $(document).on('click','#saveLikeDislike',function(){
        ...
        $.ajax({
            ...
            success:function(res){
               ...
               //     if ($(e.target).hasClass('dislike_post')) {}
               //});
               //console.log(res)

                if(res.bool == true && res.auth == true){
                    ...
                    toastr.error('Bạn cần đăng nhập để like bài viết', {timeOut: 5000});
                }               
            },				
