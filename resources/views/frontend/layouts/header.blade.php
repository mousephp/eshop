                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            ...
                            @if(Auth::guard('client')->user())
                                <li><i class="ti-user"></i><a href="{{route('member.dashboard')}}" target="_blank">Dashboard - {{Auth::guard('client')->user()->name}}</a></li>

                                <li><i class="ti-power-off"></i> <a href="{{route('member.logout')}}">Logout</a></li>
                            @else
                ...
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        ...
                        <a href="{{route('home')}}">
                            ...
                            <img src="{{asset('frontend/logo.jpg')}}" alt="logo" style="width:67px">
                        </a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                    ...
                    <div class="right-bar">
                        ...
                        <div class="sinlge-bar shopping">
                            ...
                            <div class="shopping-item">
                                ...
                                <ul class="shopping-list">
                                    <li>
                                        <a href="{{--route('cart.delete')--}}" class="remove" title="Remove this item"><i class="fa fa-remove"></i></a>
                                        <a class="cart-img" href="#"><img src="" alt=""></a>
                                        <h4><a href="{{--route('product-detail')--}}" target="_blank"></a></h4>
