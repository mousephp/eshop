    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                @if(Auth::guard('client')->user()->photo)
                <img class="img-profile rounded-circle" src="{{Auth::guard('client')->user()->photo}}">
                @else
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="{{route('member.change.password.form')}}">
                ...
                <form id="logout-form" action="{{ route('member.logout') }}" method="get" style="display: none;">
                    @csrf
                </form>
            </div>
        </li>
